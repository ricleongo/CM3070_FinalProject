...
from back_end.src.app.ml_models.mdgcn.base_model import BaseSupervisedModel
...
class SupervisedTransductiveModel(BaseSupervisedModel):
    ...
    def load_model():
        ...
        return tf.keras.models.load_model(
            "back_end/src/app/ml_models/mdgcn/transductive/model.keras",
            custom_objects={
    ...
    def save_model(self):
        ROOT_PATH = "../back_end/src/app/ml_models/mdgcn"
