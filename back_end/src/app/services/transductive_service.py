...
from back_end.src.app.schemas.fraud_history import TransactionScore
from back_end.src.app.schemas.network_risk import RiskScore
from back_end.src.app.schemas.network_laundering import LaunderingScore
from back_end.src.app.schemas.cluster_analysis import ClusterAnalysisScore
from back_end.src.app.schemas.network_subgraph import SubGraphNode, SubGraphEdge
...
class TransductiveScoringService:
    ...
    def get_top_flagged_transactions(self, top_list):
        ...
        transactions_df = pd.read_csv("back_end/data/elliptic/elliptic_txs_classes.csv")
    ...
    def _get_full_feature_predictions(self, elliptic_snapshot):
        ...
        features_df = pd.read_csv("back_end/data/elliptic/elliptic_txs_features.csv", header=None)
        classes_df = pd.read_csv("back_end/data/elliptic/elliptic_txs_classes.csv")
